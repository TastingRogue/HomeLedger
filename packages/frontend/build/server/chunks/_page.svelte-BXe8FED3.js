import { f as get, h as head, e as escape_html, s as store_get, i as attr_class, b as attr, j as clsx, c as derived, u as unsubscribe_stores } from './index.js-C_zeTiLb.js';
import { p as preferences } from './preferences-DkM7Wd8A.js';
import { t as theme } from './theme-mSLTxzCF.js';
import { t } from './index3-kSl8QoLb.js';
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    function $$render_inner($$renderer3) {
      ...
      if (isAdmin()) {
        $$renderer3.push("<!--[0-->");
        $$renderer3.push(`<button${attr_class("tab-item svelte-6qgtij", void 0, { "active": activeTab === "usuarios" })}>`);
        Icon($$renderer3, { name: "building", size: 15 });
        $$renderer3.push(`<!----> ${escape_html(store_get($$store_subs ??= {}, "$t", t)("admin.tab_users"))}</button> <button${attr_class("tab-item svelte-6qgtij", void 0, { "active": activeTab === "registro" })}>`);
        Icon($$renderer3, { name: "settings", size: 15 });
        $$renderer3.push(`<!----> ${escape_html(store_get($$store_subs ??= {}, "$t", t)("admin.tab_registration"))}</button> <button${attr_class("tab-item svelte-6qgtij", void 0, { "active": activeTab === "respaldos" })}>`);
        Icon($$renderer3, { name: "save", size: 15 });
        $$renderer3.push(`<!----> ${escape_html(store_get($$store_subs ??= {}, "$t", t)("admin.tab_snapshots"))}</button>`);
      } else {
        $$renderer3.push("<!--[-1-->");
      }
      $$renderer3.push(`<!--]--></nav> <div class="settings-content svelte-6qgtij">`);
      {
        $$renderer3.push("<!--[0-->");
        {
          $$renderer3.push("<!--[0-->");
...
//# sourceMappingURL=_page.svelte-BXe8FED3.js.map
