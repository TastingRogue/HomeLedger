import { h as head, e as escape_html, k as store_get, d as attr, u as unsubscribe_stores, F as FILENAME } from './index.js-d7AbrnM1.js';
...
function _page($$renderer, $$props) {
  $$renderer.component(
    ($$renderer2) => {
      ...
      push_element($$renderer2, "div", 137, 0);
      $$renderer2.push(`<header class="page-header svelte-1kf85nq">`);
      push_element($$renderer2, "header", 138, 2);
      $$renderer2.push(`<h1 class="svelte-1kf85nq">`);
      push_element($$renderer2, "h1", 139, 4);
      ...
      push_element($$renderer2, "button", 157, 4);
      ...
      push_element($$renderer2, "span", 160, 6);
      ...
      push_element($$renderer2, "label", 163, 4);
      $$renderer2.push(`<span class="action-icon svelte-1kf85nq">`);
      ...
      pop_element();
      $$renderer2.push(` <span class="action-desc svelte-1kf85nq">`);
      push_element($$renderer2, "span", 166, 6);
      ...
      push_element($$renderer2, "input", 168, 4);
      pop_element();
      $$renderer2.push(`</div>`);
      pop_element();
      $$renderer2.push(` `);
      ...
      push_element($$renderer2, "section", 201, 2);
      $$renderer2.push(`<h2 class="section-title svelte-1kf85nq">`);
      push_element($$renderer2, "h2", 202, 4);
      ...
      $$renderer2.push(` `);
      {
        ...
        push_element($$renderer2, "p", 204, 6);
...
//# sourceMappingURL=_page.svelte-ChJo0KE9.js.map
