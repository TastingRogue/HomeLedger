import { f as attr_class, e as escape_html, m as bind_props, l as derived, F as FILENAME } from './index.js-BJSCTNbO.js';
...
function Dropdown($$renderer, $$props) {
  $$renderer.component(
    ($$renderer2) => {
      ...
      push_element($$renderer2, "button", 30, 2);
      $$renderer2.push(`<span>`);
      push_element($$renderer2, "span", 31, 4);
      ...
      push_element($$renderer2, "svg", 32, 4);
      $$renderer2.push(`<polyline points="6 9 12 15 18 9">`);
      push_element($$renderer2, "polyline", 32, 105);
...
//# sourceMappingURL=Dropdown-Dg0Vp4ka.js.map
