import { h as head, e as escape_html, s as store_get, i as attr_class, b as attr, k as bind_props, c as derived, u as unsubscribe_stores } from './index.js-CUqUm2ke.js';
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    function $$render_inner($$renderer3) {
      ...
      $$renderer3.push(`<!--]--> <button class="btn-export svelte-mzpq19"${attr("disabled", total === 0, true)}${attr("title", store_get($$store_subs ??= {}, "$t", t)("transactions.export_csv"))}>${escape_html(store_get($$store_subs ??= {}, "$t", t)("transactions.export_csv"))}</button></div> `);
      {
        $$renderer3.push("<!--[-1-->");
      }
      $$renderer3.push(`<!--]--> `);
...
//# sourceMappingURL=_page.svelte-7Mgdva_t.js.map
