import { h as head, e as escape_html, k as store_get, d as attr, f as attr_class, F as FILENAME, u as unsubscribe_stores } from './index.js-d7AbrnM1.js';
import { p as push_element, a as pop_element } from './dev-D3dQJW43.js';
import './DatePicker-DFkdeRuq.js';
  ...
  $$renderer.component(
    ($$renderer2) => {
      ...
      function $$render_inner($$renderer3) {
        ...
        push_element($$renderer3, "div", 286, 0);
        $$renderer3.push(`<header class="page-header svelte-1di2lni">`);
        push_element($$renderer3, "header", 287, 2);
        $$renderer3.push(`<div>`);
        push_element($$renderer3, "div", 288, 4);
        $$renderer3.push(`<h1 class="svelte-1di2lni">`);
        push_element($$renderer3, "h1", 289, 6);
        ...
        push_element($$renderer3, "p", 290, 6);
        ...
        push_element($$renderer3, "button", 292, 4);
        ...
        push_element($$renderer3, "div", 295, 2);
        $$renderer3.push(`<span class="info-icon svelte-1di2lni">`);
        push_element($$renderer3, "span", 296, 4);
        $$renderer3.push(`ℹ</span>`);
        pop_element();
        $$renderer3.push(` <span>`);
        push_element($$renderer3, "span", 297, 4);
        $$renderer3.push(`${escape_html(store_get($$store_subs ??= {}, "$t", t)("subscriptions.auto_charge_info"))}</span>`);
        pop_element();
        $$renderer3.push(`</div>`);
        pop_element();
        $$renderer3.push(`  <nav class="view-tabs svelte-1di2lni" role="tablist"${attr("aria-label", store_get($$store_subs ??= {}, "$t", t)("a11y.subscriptions_views"))}>`);
        push_element($$renderer3, "nav", 302, 2);
        ...
        push_element($$renderer3, "button", 303, 4);
        ...
        push_element($$renderer3, "button", 312, 4);
        ...
        $$renderer3.push(` `);
        {
          ...
          $$renderer3.push(`<p>`);
          push_element($$renderer3, "p", 324, 27);
...
//# sourceMappingURL=_page.svelte-JrArs5aE.js.map
