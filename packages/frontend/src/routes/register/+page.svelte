...
<div class="register-container">
  <div class="register-card">
    <div class="brand-mark"><Logo size={48} /></div>
...
<style>
  .register-container {
    ...
    /* Parent .auth-layout is already min-height:100vh + centers; no second
       viewport height here (avoids the always-on vertical scrollbar). */
